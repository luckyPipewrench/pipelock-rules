...
class CompatibilityContractTests(unittest.TestCase):
    ...
    def test_ceiling_mutation_fails(self) -> None:
        ...
        contract.write_text(contract.read_text(encoding="utf-8").replace('tested_through_pipelock: "3.5.0"', 'tested_through_pipelock: "1.3.9"', 1), encoding="utf-8")
    ...
    def test_actual_version_must_equal_tested_ceiling(self) -> None:
        ...
        self.assertEqual(compatibility.tested_through_for(bundles, "pipelock-community", "3.5.0"), "3.5.0")
        with self.assertRaisesRegex(ValueError, r"tests v999\.0\.0, contract pins v3\.5\.0"):
